...
class TestLinuxBridgeRpcCallbacks(base.BaseTestCase):
    ...
    def test_fdb_add(self, proxy_enabled=False):
        fdb_entries = {'net_id':
                       {'ports':
    ...
    def test_fdb_add_with_arp_responder(self):
        cfg.CONF.set_override('arp_responder', True, 'VXLAN')
        self.test_fdb_add(proxy_enabled=True)
    ...
    def test_fdb_remove(self, proxy_enabled=False):
        fdb_entries = {'net_id':
                       {'ports':
                        {'agent_ip': [constants.FLOODING_ENTRY,
                                      ['port_mac', 'port_ip']]},
    ...
    def test_fdb_remove_with_arp_responder(self):
        cfg.CONF.set_override('arp_responder', True, 'VXLAN')
        self.test_fdb_remove(proxy_enabled=True)

    def test_fdb_update_chg_ip(self, proxy_enabled=False):
        fdb_entries = {'chg_ip':
                       {'net_id':
                        {'agent_ip':
    ...
    def test_fdb_update_chg_ip_with_arp_responder(self):
        cfg.CONF.set_override('arp_responder', True, 'VXLAN')
        self.test_fdb_update_chg_ip(proxy_enabled=True)
